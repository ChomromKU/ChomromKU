...
const Navbar = () => {
	...
	return (
		<nav data-testid="navbar" className="bg-white w-full flex items-center justify-between h-16 px-4 text-[#006664] border-b border-b-[#F2F2F2] relative">
			<Link to="/">
				<img data-testid="nav-logo" alt="chomromku" src={logo} width="0" height="0" sizes="10vw" className="h-9 w-auto" />
			</Link>
